...
_parser.add_argument('--gpu_id', default='3', type=str, help='gpu_id') 
...
_parser.add_argument('--lr', type=float, default=0.00001, help='learning rate for all types of optim')
_parser.add_argument('--momentum', type=float, default=0, help='momentum for sgd')
_parser.add_argument('--weight_decay', type=float, default=1e-4, help='weight decay for all types of optim')
## scheduler
...
def prepare_args(params):
    ...
    if params.arch in ['HPS', 'Cross_stitch', 'MTAN', 'CGC', 'PLE', 'MMoE', 'DSelect_k', 'DIY', 'LTB', 'MOLA']:
